...
export default function ProjectCard({ project, index }: ProjectCardProps) {
  ...
  return (
    <Link
      className="group focus-visible:**:data-project-card:border-ink block rounded-4xl focus-visible:outline-none focus-visible:[&_[data-project-card]]:shadow-[0_0_0_4px_#f6efe5,0_0_0_7px_#25221f]"
