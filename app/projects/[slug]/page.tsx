    ...
    >
      ...
      <section className="relative overflow-hidden border-b border-line">
        ...
        <div className="w-site mx-auto py-16 md:py-24">
          <TransitionLink
            href={`/#${project.slug}`}
            className="group inline-flex items-center gap-[0.45rem] text-muted text-[0.86rem] font-extrabold transition-all duration-180 hover:-translate-y-0.5"
          >
            <ArrowLeftIcon />
            Voltar
          </TransitionLink>
          ...
          <div className="mt-10 flex flex-col gap-6">
            ...
            <h1 className="max-w-3xl text-balance text-[clamp(2.45rem,5.5vw,4.85rem)] font-heading leading-[1.05] tracking-tight">
              {project.name}
            ...
            <p className="max-w-2xl text-pretty text-[clamp(1.05rem,1.6vw,1.15rem)] leading-[1.75] text-muted">
              {project.summary}
            </p>
      ...
      <section className="border-b border-line">
        <div className="w-site mx-auto py-12 md:py-16">
          <div className="relative aspect-[16/9] overflow-hidden rounded-md border border-line bg-[var(--project-bg)] shadow-soft">
            <Image
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="grid grid-cols-2 gap-4 max-md:grid-cols-1">
                {project.gallery.map((image, index) => (
                  <figure
                    key={image}
                    className={index === 0 ? 'flex flex-col gap-3 col-span-2 max-md:col-span-1' : 'flex flex-col gap-3'}
                  >
