...
export default function ProjectVisual({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-[2] flex justify-between p-5 text-[0.72rem] font-extrabold tracking-widest uppercase">
        <span>0{project.id}</span>
        <span>{project.year}</span>
      </div>
      <div
        className="relative z-[1] my-auto -rotate-9 self-center text-center text-[clamp(3rem,7vw,8rem)] leading-[0.76] font-normal tracking-[-0.12em] transition duration-[450ms] group-hover:scale-105 group-hover:rotate-3 max-[480px]:text-[clamp(3rem,16vw,4.6rem)]"
        aria-hidden="true"
      >
        {project.name}
      </div>
