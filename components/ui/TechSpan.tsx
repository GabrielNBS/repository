export default function TechSpan({ children }: { children: React.ReactNode }) {
  return (
    <li
      className="flex items-center justify-center bg-background px-8 py-4 text-foreground rounded-2xl text-base
