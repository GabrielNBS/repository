...
export default function ProjectRowItem({ project, index, priority = false, isExtra = false }: ProjectRowItemProps) {
  ...
  return (
    <div
      className={`project-row-item gap-grid border-line grid grid-cols-1 items-center border-b py-4 lg:grid-cols-12 lg:py-2.5 ${
        isExtra ? 'project-row-extra opacity-0 overflow-hidden' : ''
      }`}
      style={
        isExtra
          ? {
    ...
    >
      ...
      <div className="lg:col-span-6">
        ...
        >
          <div className="flex items-center gap-4 md:gap-6">
            ...
            <div>
              <h3 className="text-ink group-hover:text-accent font-soft text-xl leading-tight transition-colors duration-300 md:text-2xl">
                {project.name}
              </h3>
          ...
          <div className="flex items-center gap-6 md:gap-10">
            ...
            <span className="text-accent transform text-xl font-light transition-transform duration-300 group-hover:translate-x-1.5 md:text-2xl">
              →
            </span>
          </div>
        </TransitionLink>
      ...
      <div className="mt-6 lg:col-span-6 lg:mt-0">
        <div className="mockup-container border-line bg-paper shadow-soft group relative mx-auto aspect-[16/10] w-full max-w-[340px] overflow-hidden rounded-2xl border transition-transform duration-300 hover:scale-[1.01] lg:ml-auto lg:max-w-[200px] xl:max-w-[245px] 2xl:max-w-[280px]">
